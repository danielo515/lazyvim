...
map("n", "<Tab>", "<cmd>lua require('user.telescope').buffers()<cr>", { desc = "List open buffers using Telescope" })
map("n", "<S-Tab>", ":Neotree float reveal<cr>", { desc = "Toggle Neotree file explorer" })
map("n", "<C-N>", ":NvimTreeFindFile<cr>", { desc = "Find the current file in NvimTree" })
